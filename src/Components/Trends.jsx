...
const Trends = () => {
  return (
    <div id="Trends" className="mb-[100px] pb-10">
    <Navbar/>
    <div className="flex flex-col justify-center lg:flex-row gap-2 lg:items-center lg:justify-center mx-auto lg  my-20 max-w-[1360px]  ">
